...
export const HP_THRESHOLD_ARC   = 85;       // below this → short-circuit electric arcs
export const HP_THRESHOLD_SMOKE = 55;       // below this → smoke trail (was 65)
export const HP_THRESHOLD_FIRE  = 25;       // below this → flames (was 35)
